...
export function LegalPage({ kind }: { kind: LegalKind }) {
  ...
  const effectiveDate = {
    ko: "시행일: 2026년 7월 30일",
    en: "Effective date: July 30, 2026",
    ja: "施行日：2026年7月30日",
  }[lang];
    ...
    <>
          ...
          <table>
            ...
            <tbody>
              ...
              <tr>
                <td>서비스 제공</td>
                <td>
                  사용자명, 소개, 프로필 이미지와 파일 형식·크기, 공개 프로필 설정, 연합우주 활성화
                  설정·핸들·공개키, 원격 팔로워의 Actor·inbox 주소, 발행
                  상태, 언어, 시청 날짜, 콘텐츠 제목·유형·외부 콘텐츠 ID,
                  반응, 감상, 이용 플랫폼
                </td>
              </tr>
              <tr>
      ...
      <section>
        ...
        <p>
          ...
          소개, 프로필 이미지, 시청 날짜별 건수, 총 기록 수와 최근 콘텐츠
          포스터가 공개됩니다. 공개 옵션을 끄면 해당 프로필은 더 이상
          공개되지 않습니다. 프로필 이미지 파일은 공개 R2 주소로 제공되므로
          URL을 알고 있거나 이미 캐시한 제3자는 공개 옵션을 끈 뒤에도 접근할
          수 있습니다.
        </p>
        <p>
          연합우주 기능은 공개 프로필과 별개의 선택 기능이며 기본적으로
          비활성화되어 있습니다. 이용자가 마이페이지에서 직접 활성화하면
          연합우주 핸들, 이름, 소개, 프로필 이미지, Actor 정보와 공개키가 공개되고, 팔로우한
          독립 ActivityPub 서버로 콘텐츠 제목·시청 날짜·반응·감상·공개
          페이지 URL이 전송될 수 있습니다. 해당 서버는 각자의 정책에 따라
          이를 국외에서 처리하고 캐시하거나 재배포할 수 있습니다.
        </p>
        <p>
          연합우주 기능을 끄면 이후 발행과 Actor 공개가 중단됩니다. 기록
          삭제 시 원격 서버에 삭제 활동을 보내지만, 운영자는 독립된 원격
          서버의 캐시·백업·스크린샷 또는 재배포본까지 삭제된다고 보장할 수
          없습니다.
        </p>
        <p>
          ...
          <table>
            ...
            <tbody>
              <tr>
                ...
                <td>
                  웹 호스팅, API 실행, D1 데이터베이스, R2 이미지 저장, 보안과 장애 로그
                </td>
                <td>
      ...
      <section>
        ...
        <p>
          ...
          수정·삭제하거나 Markdown으로 내보낼 수 있으며, 공개 프로필과
          연합우주 기능은 마이페이지에서 언제든 비활성화할 수 있습니다.
        </p>
        <p>
    ...
    <>
      ...
      <section>
        ...
        <ul>
          ...
          <li>
            이용자가 별도로 활성화한 경우 연합우주 팔로우를 받고 감상을
            ActivityPub 서버로 발행하는 기능
          </li>
      ...
      <section>
        ...
        <p>
          이용자가 연합우주 기능을 활성화하면 선택한 사용자 콘텐츠를 독립된
          ActivityPub 서버와 그 이용자에게 전송·표시할 수 있는 권한도 위
          이용 권한에 포함됩니다. 기능을 끄면 이후 발행은 중단되며, 기록
          삭제 시 삭제 활동을 전송하지만 원격 서버의 캐시·백업·스크린샷
          또는 재배포본까지 삭제되는 것은 보장되지 않습니다.
        </p>
      </section>
      ...
      <section>
        <h2>제6조 외부 서비스</h2>
        <p>
          서비스는 TMDB, YouTube, Cloudflare, Google Analytics와 이용자가
          연합우주 기능을 활성화한 경우 독립된 ActivityPub 서버 등 제3자의
      ...
      <section>
        ...
        <p>
          ...
          을 따릅니다. 공개 프로필과 연합우주 기능은 각각 이용자가 직접
          해당 옵션을 켠 경우에만 활성화됩니다.
        </p>
      </section>
